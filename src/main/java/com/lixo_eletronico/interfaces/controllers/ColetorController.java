...
@RestController
@RequestMapping("/coletores/test")
public class ColetorController {

	@GetMapping
	public ResponseEntity<CreateUsuarioColetorResponseDTO> cadastrarCliente() {
		

		return ResponseEntity.status(HttpStatus.CREATED).body(new CreateUsuarioColetorResponseDTO("teste", null, null, null, null));
	}
}
